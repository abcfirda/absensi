...
>
  <head>
    ...
    <title>Data Tables Admin | SiMaK</title>
          ...
          <ul class="menu-inner py-1">
            ...
            <!-- <li class="menu-item">
              ...
              <ul class="menu-sub">
                ...
                <li>
                <a href="<?php echo base_url(); ?>index.php/user/tabelanbsent" class="menu-link">
            ...
            <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
              ...
              <div class="navbar-nav align-items-right">
                <div class="nav-item d-flex align-items-center">
                  ...
                  <span class="form-control border-0 shadow-none fs-5">Data User</span></div>
               </div>
              <!-- /Search -->
