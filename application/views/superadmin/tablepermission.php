...
>
  <head>
    ...
    <title>Tables Permission | SiMaK</title>
            ...
            <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
              ...
              <div class="navbar-nav align-items-right">
                <div class="nav-item d-flex align-items-center">
                  ...
                  /
                  <a href="<?php echo base_url(); ?>index.php/user/tablepermission">
                  Permission
                  </a>
                </span></div>
               </div>
                    ...
                    <table id="table1" class="table table-bordered">
                      ...
                      <tbody>
                        ...
                        <tr align ="center">
                          ...
                          <td><span class="badge bg-label-warning"><?php echo $status;?></span></td>
                          <td>
                          <div class="dropdown">
                              <button
                                type="button"
