...
>
  <head>
    ...
    <title>Edit Data User | SiMaK</title>
        ...
        <div class="layout-page">
            ...
            <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
              ...
              <div class="navbar-nav align-items-right">
                <div class="nav-item d-flex align-items-center">
                  ...
                  <a href="<?php echo base_url(); ?>index.php/user/table_user" class="link-secondary">
                  Data User
                  </a>
                  /
          ...
          <div class="content-wrapper">
            ...
            <div class="col-md-8">
                <br></br>
                <br></br>
            <h2 class="card-header text-black my-auto titledata">PROFILE DETAIL</h2>
            </div>
                <div class="card-body">
              <form action="<?php echo base_url('index.php/user/functionEdit')?>" method="post">
              <div class="mbtom-45">
                <input type="hidden" class="form-control form-control-lg rounded-4" name="id_user" id="exampleFormControlInput1" value="<?php echo $userdata->id_user ?>">
              </div>
              <div class="row justify-content-evenly">
                <div class="col-6">
                  <div class="mb-3">
                      <label for="exampleFormControlInput1" class="form-label">NIS</label>
                      <input type="text" class="form-control form-control-lg rounded-4" name="nis" id="exampleFormControlInput1" value="<?php echo $userdata->nis ?>">
                  </div>       
                </div>
                <div class="col-6">
                  <div class="mb-3">
                      <label for="exampleFormControlInput1" class="form-label">Pass</label>
                      <input type="text" class="form-control form-control-lg rounded-4" name="pass" id="exampleFormControlInput1" value="<?php echo $userdata->pass ?>">
                  </div>
                </div>
              </div>
              ...
              <div class="mbtom-45">
                ...
                <input type="text" class="form-control form-control-lg rounded-4" name="imei" id="exampleFormControlInput1" value="<?php echo $userdata->imei ?>">
              </div>
              <button type="submit" class="btn btn-primary me-4 px-3 py-25 mb-5 rounded-4">Save Changes</button>
