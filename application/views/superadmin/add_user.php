...
>
  <head>
    ...
    <title>Tambah Data User | SiMaK</title>
      ...
      <div class="layout-container">
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <br></br>
            <br></br>
            <h2 class="card-header text-black my-auto titledata">ADD USER</h2>
            </div>
                <div class="card-body">
              ...
              <div class="row justify-content-evenly">
                <div class="col-6">
                  <div class="mb-3">
                      ...
                      <input type="text" class="form-control form-control-lg rounded-4" name="nis" id="exampleFormControlInput1" >
                  </div>       
                </div>
                <div class="col-6">
                  <div class="mb-3">
                      <label for="exampleFormControlInput1" class="form-label">Pass</label>
                      <input type="text" class="form-control form-control-lg rounded-4" name="pass" id="exampleFormControlInput1">
                  </div>
                </div>
              </div>
              ...
              <div class="mbtom-45">
                ...
                <input type="text" class="form-control form-control-lg rounded-4" name="imei" id="exampleFormControlInput1">
              </div>
