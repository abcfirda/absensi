...
<head>
  ...
  <title>Tables Siswa | SiMaK</title>
      ...
      <div class="layout-page">
          ...
          <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
            ...
            <div class="navbar-nav align-items-right">
              <div class="nav-item d-flex align-items-center">
                ...
                <span class="form-control border-0 shadow-none fs-5">Data Siswa</span>
              </div>
            </div>
            <!-- /Search -->
        ...
        <div class="content-wrapper">
          ...
          <div class="container-xxl flex-grow-1 container-p-y">
            <ul class="nav">
              <li class="nav-item">
                <a class="nav-link active" aria-current="page" href="<?php echo base_url(); ?>index.php/user/grade1">Class X</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="<?php echo base_url(); ?>index.php/user/grade2">Class XI</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="<?php echo base_url(); ?>index.php/user/grade3">Class XII</a>
              </li>
            </ul>
            <!-- Bordered Table -->
            <div class="card">
              <div class="card-body pt-0">
                <div class="dataTables3_length" id="table3_length">
                  ...
                  <div class="dropdown">
                    ...
                    <ul class="dropdown-menu grade">
                      ...
                      <li><a class="dropdown-item" href="<?php echo base_url(); ?>index.php/user/rplc">RPL C</a></li>
                      <li><a class="dropdown-item" href="<?php echo base_url(); ?>index.php/user/tkja">TKJ A</a></li>
                      ...
                      <li><a class="dropdown-item" href="<?php echo base_url(); ?>index.php/user/loga">LOG A</a></li>
                      ...
                      <li><a class="dropdown-item" href="<?php echo base_url(); ?>index.php/user/mekab">MEKA B</a></li>
                      ...
                      <li><a class="dropdown-item" href="<?php echo base_url(); ?>index.php/user/pda">PD A</a></li>
                ...
                <?php } ?>
                <form action="<?= base_url('index.php/user/import_excel'); ?>" method="post" enctype="multipart/form-data">
                      ...
                      <div class="modal-content">
                        ...
                        <div class="modal-body pt-0">
                          ...
                          <div class="input-group mt-4 mb-1">
                            <input type="file" name="fileExcel" class="form-control" id="inputGroupFile01">
                      ...
                      <td>
                        <div class="dropdown">
                          ...
                          <div class="dropdown-menu">
                            <a class="dropdown-item" href="<?= base_url(); ?>index.php/user/editprofile"><i class="bx bx-edit-alt me-1"></i> Edit</a>
                            <a class="dropdown-item" href="<?php echo base_url('index.php/user/deleteSiswa'); ?>/<?php echo $id_siswa ?>">
