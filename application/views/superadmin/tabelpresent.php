...
<head>
  ...
  <title>Tables Present | SiMaK</title>
            ...
            <div class="navbar-nav align-items-right">
              <div class="nav-item d-flex align-items-center">
                ...
                <span class="form-control border-0 shadow-none ms-2 fs-5">
                  ...
                  /
                  <a href="<?php echo base_url(); ?>index.php/user/tabelpresent">
                    Present
                  </a>
                </span>
              </div>
              ...
              <div class="card-body pt-0">
                <div class="dataTables3_length" id="table3_length">
                  ...
                  <div class="col-4">
                    ...
                    <input type="date" placeholder="Date" onClick="$(this).removeClass('placeholderclass')" class="dateclass placeholderclass">
                  </div>
                </div>
                

                <div class="table-responsive text-nowrap mt-6 mb-1">
                  <table id="table1" class="table table-bordered">
                    ...
                    <tbody>
                      ...
                      <tr align="center">
                        ...
                        <span class="badge bg-label-success"><?php echo $status; ?></span>
                        <?php } elseif ($status == 'toolate') {?>
                          <span class="badge bg-label-info"><?php echo $status; ?></span>
                          <?php }?>
                      </td>
                        <td><button type="button" class="btn" data-bs-toggle="modal" data-bs-target="#exampleModal"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-geo-alt" viewBox="0 0 16 16">
            ...
            <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
              <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                  ...
                  <div id="map-canvas" class="col-sm-12" style="height:380px;"></div>s
                  </div>
...
<script>    
    ...
    function initialize() {  
        ...
        <?php
            // $query = mysql_query("SELECT * FROM clockin");
