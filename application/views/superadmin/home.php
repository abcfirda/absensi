<!DOCTYPE html>
<?php
$user = $this->session->userdata('sadmin');
extract($user);
?>
<html
  lang="en"
...
>
  <head>
    ...
    <title>Dashboard Super Admin | SiMaK</title>
                ...
                <div class="col-lg-8 mb-1 order-1">
                  <div class="card" style="height:18.75rem;">
                    <div class="d-flex align-items-end row">
                      <div class="col-sm-7">
                        <div class="card-body">
                          <h1 class="card-title mt-3 mb-0 ms-4 text-dark" style="font-size:2.5em; font-weight: bold;">Welcome, Super Admin</h1>
