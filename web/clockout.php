...
if (!isset($_SESSION['nis'])) {
 ...
 if(isset($_POST['submit1'])){
    ...
    $query = mysqli_query($conn, "INSERT INTO data_clockout VALUES (NULL,$nis,'$nama',$no_absen,'$kelas','$latitude','$longitude',null)");
    if($query){
        echo" <script type='text/javascript'>alert('Berhasil clockout');</script>";
